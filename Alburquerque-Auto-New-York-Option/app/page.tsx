    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#home" aria-label="Alburquerque Auto home">
          ...
          <span><strong>ALBURQUERQUE</strong><small>NEW YORK AUTO</small></span>
        </a>
      ...
      <section className="hero" id="home">
        ...
        <div className="eyebrow"><span></span> Independent automotive specialist · New York</div>
        <h1>NEW YORK<br />KEEPS <em>MOVING.</em></h1>
        <p className="hero-copy">Your car should too. Diagnostics, repairs, maintenance, and performance work built for New York miles—and the people who drive them.</p>
        ...
        <div className="hero-stats">
          ...
          <div><strong>NY-READY</strong><span>Multi-make expertise</span></div>
        </div>
      ...
      <section className="marquee" aria-label="Core values">
        <div className="marquee-track">
          <div className="marquee-group">
            <span>NEW YORK AUTOMOTIVE</span><i>◆</i><span>HONESTY & QUALITY</span><i>◆</i><span>EXPERTISE ACROSS MAKES</span><i>◆</i><span>DIAGNOSTICS & REPAIRS</span><i>◆</i>
          </div>
      ...
      <section className="ny-strip" aria-label="New York service promise">
        <div className="street-sign"><small>LOCAL SERVICE</small><strong>NEW YORK</strong><span>ONE OWNER · ONE STANDARD</span></div>
        <div className="ny-promise"><span>BUILT FOR THE CITY</span><p>Stop-and-go traffic. Potholes. Heat, cold, salt, and long commutes. New York asks a lot of a vehicle. Alburquerque Auto understands the conditions—and fixes the cause, not just the symptom.</p></div>
        <div className="route-mark" aria-hidden="true"><b>NY</b><strong>A</strong></div>
      </section>

      <section className="section services" id="services">
        <div className="section-heading">
          <div><span className="kicker">WHAT WE DO</span><h2>SKILL FOR THE<br /><em>WHOLE MACHINE.</em></h2></div>
          <p>From a warning light in Midtown traffic to performance work you’ve been planning, every job starts with understanding the vehicle—and your goals.</p>
        </div>
      ...
      <section className="about" id="about">
        ...
        <div className="about-copy">
          ...
          <h2>NEW YORK DIRECT.<br /><em>NO RUNAROUND.</em></h2>
          <p className="lead">“Let’s get that issue that’s in need of attention taken care of.”</p>
          <p>Alburquerque Auto was built around a simple idea: New York clients deserve to understand what is happening with their car. That means careful diagnostics, honest recommendations, and quality work across many different makes and models.</p>
      ...
      <section className="contact" id="contact">
        ...
        <div className="hours"><h3>Appointment hours</h3>{hours.map(([day,time]) => <div key={day}><span>{day}</span><b>{time}</b></div>)}<p>Proudly serving New York drivers.</p></div>
      </section>
      ...
      <footer>
        ...
        <p>© {new Date().getFullYear()} Alburquerque Auto · New York. All rights reserved.</p>
      </footer>
    </main>
  );
}
