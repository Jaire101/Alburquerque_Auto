  ...
  return (
    <main>
      <header className="site-header">
        ...
        <a className="header-cta" href="tel:+14753492969">
          Call (475) 349-2969
        </a>
      </header>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-stats">
          <div>
            <strong>$100</strong>
            <span>Diagnostic starting rate</span>
          </div>
          <div>
            <strong>
              $150<small>/HR</small>
      ...
      <section className="marquee" aria-label="Core values">
        <div className="marquee-track">
          <div className="marquee-group">
            ...
            <i>◆</i>
            <span>EXPERTISE ACROSS MAKES</span>
            <i>◆</i>
            <span>DIAGNOSTICS & REPAIRS</span>
            <i>◆</i>
          </div>
      ...
      <section className="section services" id="services">
        <div className="section-heading">
          ...
          <p>
            From a warning light in Midtown traffic to performance work you’ve
            been planning, every job starts with understanding the vehicle—and
            your goals.
          </p>
        </div>
        ...
        <div className="about-copy">
          ...
          <div className="values">
            <div>
              <b>01</b>
              <span>
                <strong>Honesty first</strong>
                <small>No pressure. Clear findings and real options.</small>
              </span>
            </div>
            <div>
              <b>02</b>
              <span>
                ...
                <small>Work approached with pride and attention.</small>
              </span>
            </div>
            <div>
              <b>03</b>
              <span>
                <strong>Broad expertise</strong>
                <small>Knowledge that reaches beyond one badge.</small>
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="process section">
        ...
        <div className="process-row">
          <div>
            ...
            <p>
              Share the symptoms, vehicle details, and timing that works for
              you.
            </p>
          </div>
          <div>
            ...
            <p>
              The shop reviews your request and follows up with timing and a
              quote.
            </p>
          </div>
          <div>
            ...
            <p>
              Major maintenance may require a deposit before parts or time are
              reserved.
            </p>
          </div>
          <div>
            <span>04</span>
            <h3>Drive informed</h3>
            <p>
              Leave knowing what was done and what your vehicle may need next.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="booking" id="booking">
        <div className="booking-info">
          ...
          <p>
            Send the details below. This is a request—not a confirmed
            appointment. The owner will follow up to confirm availability,
            timing, and any quote or deposit.
          </p>
          <div className="policy-note">
            <b>PLEASE NOTE</b>
            <span>
              Same-day service requires a phone call. Major work should be
              requested 48 hours to 2 weeks ahead.
            </span>
          </div>
        </div>
        <form className="booking-form" onSubmit={submitBooking}>
          {submitted ? (
            <div className="success" role="status">
              ...
              <p>
                Thanks—your appointment details are ready for review. For this
                preview, no information was sent. Connect the final booking
                service to deliver confirmations and reminders.
              </p>
            ...
            <>
              ...
              <label>
                ...
                <textarea
                  ...
                  name="concern"
                  rows={4}
                  placeholder="Describe what you’re noticing, any warning lights, sounds, or recent work…"
                ></textarea>
              </label>
              <label className="check">
                <input required type="checkbox" />
                <span>
                  I understand this is a request. Appointments are confirmed by
                  the owner, and cancellations for major work may forfeit the
                  deposit.
                </span>
              </label>
              ...
              <small className="form-fine">
                You’ll receive confirmation after the owner reviews your
                request. Reminder timing: 24 hours before confirmed
                appointments.
              </small>
            </>
          )}
      ...
      <section className="contact" id="contact">
        <div className="contact-main">
          ...
          <h2>
            A BETTER ANSWER
            <br />
            IS ONE <em>CALL AWAY.</em>
          </h2>
          <a className="phone" href="tel:+14753492969">
            (475) 349-2969 <span>↗</span>
          </a>
          <a className="email" href="mailto:lexusis3002jzgte@yahoo.com">
            lexusis3002jzgte@yahoo.com
          </a>
        </div>
        <div className="hours">
      ...
      <footer>
        ...
        <div className="footer-links">
          ...
          <a
            href="https://www.instagram.com/ozzy_shiftz/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Visit Alburquerque Auto on Instagram"
          >
            Instagram ↗
          </a>
        </div>
